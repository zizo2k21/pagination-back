...
const pool = mysql.createPool({
    host:process.env.MYSQL_HOST ? process.env.MYSQL_HOST:"unixshell.hetic.glassworks.tech",
    port:process.env.MYSQL_PORT ? process.env.MYSQL_PORT:"27116",
    user:process.env.MYSQL_USER ? process.env.MYSQL_USER:"student",
    password:process.env.MYSQL_PWD ? process.env.MYSQL_PWD:"Tk0Uc2o2mwqcnIA",
    database:process.env.MYSQL_DATABASE ? process.env.MYSQL_DATABASE:'sakila'
}).promise()
